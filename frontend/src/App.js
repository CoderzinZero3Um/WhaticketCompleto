    ...
    const theme = createTheme(
        {
            ...
            palette: {
                type: mode,
                primary: { main: "#f48220" },
                textPrimary: mode === "light" ? "#f48220" : "#FFFFFF",
                borderPrimary: mode === "light" ? "#f48220" : "#FFFFFF",
                dark: { main: mode === "light" ? "#333333" : "#F3F3F3" },
                light: { main: mode === "light" ? "#F3F3F3" : "#333333" },
                tabHeaderBackground: mode === "light" ? "#EEE" : "#333",
                optionsBackground: mode === "light" ? "#fafafa" : "#333",
                options: mode === "light" ? "#fafafa" : "#666",
                fontecor: mode === "light" ? "#f48220" : "#fff",
                ...
                barraSuperior: mode === "light" ? "linear-gradient(to right, #f48220, #f48220, #f48220)" : "#666",
                boxticket: mode === "light" ? "#EEE" : "#333",
